	                    ...
	                    <form class="form-horizontal form-label-left">
	                      ...
	                      <div class="form-group">
	                        ...
	                        <div class="col-md-6 col-sm-6 col-xs-12">
	                          <input name="ip" type="text" class="form-control" placeholder="请输入IP地址">
	                        </div>
	                      </div>
	                      <div class="form-group">
	                          ...
	                          <select class="select2_multiple form-control" multiple="multiple" required name="serviceIds">
	                          	<#if services??>
	                          		<#list services as server>
		                          		<option value="${server.serviceId}" <#if service??&&service.serviceId==server.serviceId> selected="selected"</#if>>${server.serviceName}</option>
	                          		</#list>
	                          	<#else>
